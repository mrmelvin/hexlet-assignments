...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        // BEGIN
        String queryAddArticle = "INSERT INTO articles (title, body) VALUES (?, ?)";
        try {
            PreparedStatement statement = connection.prepareStatement(queryAddArticle);
    ...
    private void updateArticle(HttpServletRequest request,
        ...
        // BEGIN
        String queryUpdateArticle = "UPDATE articles SET title = ?, body = ? WHERE id = ?";
        try {
            PreparedStatement statement = connection.prepareStatement(queryUpdateArticle);
            statement.setString(1, title);
            statement.setString(2, body);
    ...
    private void destroyArticle(HttpServletRequest request,
        ...
        // BEGIN
        String queryDelete = "DELETE FROM articles WHERE id = ?";
        try {
